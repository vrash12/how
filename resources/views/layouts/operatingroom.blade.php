...
<html lang="en">
  <head>
      ...
      <title>Operating Room • PatientCare</title>
  ...
  <body>
    ...
    <aside class="sidebar text-white">
      ...
      <nav class="nav flex-column mb-4">
        ...
        <div class="section-label">OR Management</div>

        <a href="{{ route('operating.queue') }}" 
           class="nav-link d-flex align-items-center mb-2 {{ request()->routeIs('operating.queue') ? 'active' : '' }}">
            <i class="fas fa-procedures fa-lg me-2"></i>
            <span>OR Queue</span>
        </a>

        <a href="{{ route('operating.history') }}"
           class="nav-link d-flex align-items-center mb-2 {{ request()->routeIs('operating.history') ? 'active' : '' }}">
          <i class="fa-solid fa-timeline fa-lg me-2"></i>
          <span>OR History</span>
        </a>
      </nav>
